...
def generate_audio_waveforms(sentences: list[str], output_dir: str, voice: PiperVoice):
    ...
    for i, text in enumerate(sentences, start=1):
        ...
        # BELOW is for gTTS
        # commented out due to need for internet access
...
def generate_latent_and_mel(file_dir: str, save_dir: str, model_dir: str, tts_dir: str, fast_sampling=True):
...
if __name__ == "__main__":
    generate_latent_and_mel("/scratch/wongbr55/brain_to_text_25/t15_copyTask_neuralData/hdf5_data_final",
                            ...
                            "/home/wongbr55/diff_brain_decoding/diffwave_expose_latent_space/pretrained_model/en_US-amy-medium.onnx")